  ...
  return (
    <section className="bg-white rounded-xl shadow-sm p-6">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4">
        ...
        <StatCard icon={MdDiversity2} label="Drawing Room" value="Available" valueClass="text-green-600" />
        <StatCard icon={MdDining} label="Dining Room" value="Available" valueClass="text-green-600" />
        <StatCard icon={FaKitchenSet} label="Kitchen" value="Big Kitchen" />
        <StatCard icon={MdLiving} label="Family Living" value="Available" valueClass="text-green-600" />
      </div>

      <div className="mt-8">
        <h2 className="text-2xl font-bold mb-3">Property Description</h2>
        <p className="text-sm text-gray-700 leading-relaxed bg-gray-50 p-5 rounded-lg">
